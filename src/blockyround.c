...
static void setup_blocks() {
	twelve = GRect(60, 0, 24, 24);
	one = GRect(76, 24, 24, 24);
	two = GRect(84, 48, 24, 24);
	three = GRect(92, 72, 24, 24);
	four = GRect(84, 96, 24, 24);
	five = GRect(76, 120, 24, 24);
	six = GRect(60, 144, 24, 24);
	seven = GRect(44, 120, 24, 24);
	eight = GRect(36, 96, 24, 24);
	nine = GRect(28, 72, 24, 24);
	ten = GRect(36, 48, 24, 24);
	eleven = GRect(44, 24, 24, 24);
